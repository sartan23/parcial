...
$(".crud-submit").click(function(e){
    ...
    $.ajax({
        ...
        toastr.success('se ha creado la publicacion correctamente', 'correcto', {timeOut: 5000});
...
$("body").on("click",".remove-item",function(){
    ...
    $.ajax({
        ...
        toastr.success('se ha borrado la publicacion correctamente.', 'correcto', {timeOut: 5000});
...
$(".crud-submit-edit").click(function(e){
    ...
    $.ajax({
        ...
        toastr.success('se ha actualizado la publicacion.', 'correcto', {timeOut: 5000});
